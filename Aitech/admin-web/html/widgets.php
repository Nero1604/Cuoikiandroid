      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title mb-0">Chi tiết sản phẩm</h5>
              </div>
              <table class="table">
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  while ($dong = mysqli_fetch_array($kq)) {
                    ...
                    echo '<td><a href="delete.php?idcart=' . $dong["id_cart_details"] . '"><i class="fa-solid fa-trash"></i></a></td>';
                    echo '<td><a href="update.php?idcart=' . $dong["id_cart_details"] . '"><i class="fa-solid fa-pen-to-square"></i></a></td>';          
                    echo '</tr>';
                  }
