            ...
            <div class="col-md-6 col-lg-2 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-warning text-center">
                  ...
                  <h6 class="text-white">Giỏ hàng</h6>
                </div>
              </div>
            </div>
            <!-- Column -->
            <div class="col-md-6 col-lg-2 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-danger text-center">
                  ...
                  <h6 class="text-white">Người dùng</h6>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-2 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-danger text-center">
                  ...
                  <h6 class="text-white">Sản phẩm</h6>
                </div>
              </div>
            </div>
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="bg-dark p-10 text-white text-center">
                            ...
                            <small class="font-light">Người dùng</small>
                          </div>
                        </div>
                        <div class="col-6">
                          <div class="bg-dark p-10 text-white text-center">
                          <i class="fa-solid fa-sack-dollar"></i>
                            ...
                            <small class="font-light">Doanh thu</small>
                          </div>
                        </div>
                        <div class="col-6 mt-3">
                          <div class="bg-dark p-10 text-white text-center">
                            ...
                            <small class="font-light">Hàng hóa</small>
                          </div>
                        </div>
                        <div class="col-6 mt-3">
                          <div class="bg-dark p-10 text-white text-center">
                            <i class="mdi mdi-tag fs-3 mb-1 font-16"></i>
                            <h5 class="mb-0 mt-1">4</h5>
                            <small class="font-light">Sản phẩm bán ra</small>
                          </div>
                        </div>
                        <div class="col-6 mt-3">
                          <div class="bg-dark p-10 text-white text-center">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
             ...
             <form action="sendmess.php" method="POST">
                    ...
                    <div class="col-3">
                      <button type="submit"><a class="btn-circle btn-lg btn-cyan float-end text-white"
                        href="javascript:void(0)"><i class="mdi mdi-send fs-3"></i></a></button>
                      <!-- <a
