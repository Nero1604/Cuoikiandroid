...
<html dir="ltr" lang="en">
  <head>
    ...
    $sql = "SELECT * FROM `cart_payments` WHERE `id_cart`='$iddh'";
    $kq = mysqli_query($conn, $sql);
    while ($dong = mysqli_fetch_array($kq)) {
        $name_user = $dong["name_user"];
        $cart_date = $dong["cart_date"];
        $cart_cost = $dong["cart_cost"];
        $cart_payment = $dong["cart_payment"];
    }
    ?>
     <div class="label1">
        <form action="them.php" method="POST">
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control" id="formGroupExampleInput" value="<?php echo $name_user; ?>">
            </div>
            <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">Price</label>
                <input type="text" name="price" class="form-control" id="formGroupExampleInput2" value="<?php echo $cart_cost; ?>">
            </div>
            <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">Date</label>
                <input type="text" name="date" class="form-control" id="formGroupExampleInput2" value="<?php echo $cart_date; ?>">
            </div>
            <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">Cart payment</label>
                <input type="text" name="cart_payment" class="form-control" id="formGroupExampleInput2" value="<?php echo $cart_payment; ?>">
            </div>
