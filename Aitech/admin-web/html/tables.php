              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  while ($dong = mysqli_fetch_array($kq)) {
                    ...
                    echo  '<td>' . $dong["gender"] . '</td>';
                    echo '<td><a href="delete.php?iduser=' . $dong["id"] . '"><i class="fa-solid fa-trash"></i></a></td>';
                    echo '<td><a href="update.php?iduser=' . $dong["id"] . '"><i class="fa-solid fa-pen-to-square"></i></a></td>';
                    echo '</tr>';
                  }
