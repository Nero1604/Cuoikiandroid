...
<html dir="ltr" lang="en">
  <head>
    ...
    while ($dong = mysqli_fetch_array($kq)) {
        $name = $dong["name_product"];
        $price = $dong["cost_product"];
        $category = $dong["category"];
        $detail = $dong["detail_product"];
    }
    ?>
     <div class="label1">
        <form action="them.php" method="POST">
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control" id="formGroupExampleInput" value="<?php echo $name; ?>">
            </div>
            <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">Price</label>
                <input type="text" name="price" class="form-control" id="formGroupExampleInput2" value="<?php echo $price; ?>">
            </div>
            <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">category</label>
                <input type="text" name="category" class="form-control" id="formGroupExampleInput2" value="<?php echo $category; ?>">
            </div>
            <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">Detail</label>
                <input type="text" name="detail" class="form-control" id="formGroupExampleInput2" value="<?php echo $detail; ?>">
            </div>
