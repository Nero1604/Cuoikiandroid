      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  while ($dong = mysqli_fetch_array($kq)) {
                    ...
                    echo  '<td>' . $dong["name_product"] . '</td>';
                    echo  '<td>' . $dong["cost_product"] . '</td>';
                    echo  '<td>' . $dong["category"] . '</td>';
                    echo  '<td>' . $dong["detail_product"] . '</td>';
                    echo '<td><a href="delete.php?idsp=' . $dong["id_product"] . '"><i class="fa-solid fa-trash"></i></a></td>';
                    echo '<td><a href="updateproduct.php?idsp=' . $dong["id_product"] . '"><i class="fa-solid fa-pen-to-square"></i></a></td>';
                    echo '</tr>';
                  }
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title mb-0">Loại sản phẩm</h5>
              </div>
              <div class="table-responsive">
                <table class="table">
                  ...
                  while ($dong = mysqli_fetch_array($kq)) {
                    ...
                    echo  '<th scope="row">' . $stt++ . '</th>';
                    echo  '<td>' . $dong["category"] . '</td>';
                    echo '<td><a href="delete.php?idcategory=' . $dong["id_category"] . '"><i class="fa-solid fa-trash"></i></a></td>';
                    echo '<td><a href="updatecategory.php?idcategory=' . $dong["id_category"] . '"><i class="fa-solid fa-pen-to-square"></i></a></td>';          
                    echo '</tr>';
                  }
                  ?>
