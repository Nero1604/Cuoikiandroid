        ...
        <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Giỏ hàng</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Người dùng</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
                  ...
                  aria-expanded="false"
                  ><i class="mdi mdi-border-inside"></i
                  ><span class="hide-menu">Sản phẩm</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
                  ...
                  aria-expanded="false"
                  ><i class="mdi mdi-border-inside"></i
                  ><span class="hide-menu">Đơn hàng</span></a
                >
              </li>
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Đánh giá</span></a
                >
              </li>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title mb-0">Đơn hàng</h5>
              </div>
              <table class="table">
                <thead>
                  <tr>
                    <th scope="col">#</th>
                    <th scope="col">Người mua</th>
                    <th scope="col">ngày</th>
                    <th scope="col">Giá</th>
                    <th scope="col">Phương thức thanh toán</th>
                  </tr>
                </thead>
                <tbody>
                  <?php
                  ...
                  $sql = "SELECT * FROM `cart_payments`";
                  $kq = mysqli_query($conn, $sql);
                  while ($dong = mysqli_fetch_array($kq)) {
                    echo '<tr>';
                    echo  '<th scope="row">' . $stt++ . '</th>';
                    echo  '<td>' . $dong["name_user"] . '</td>';
                    echo  '<td>' . $dong["cart_date"] . '</td>';
                    echo  '<td>' . $dong["cart_cost"] . '</td>';
                    echo  '<td>' . $dong["cart_payment"] . '</td>';
                    echo '<td><a href="delete.php?iddh=' . $dong["id_cart"] . '"><i class="fa-solid fa-trash"></i></a></td>';
                    echo '<td><a href="updatedonhang.php?iddh=' . $dong["id_cart"] . '"><i class="fa-solid fa-pen-to-square"></i></a></td>';          
                
                    echo '</tr>';
                  }
                  $_SESSION['totaluser']=$stt;
                  ?>
                </tbody>
              </table>
            </div>
              ...
              <div class="table-responsive">
                <table class="table">
                  ...
                  while ($dong = mysqli_fetch_array($kq)) {
                    ...
                    echo  '<td>' . $dong["phone"] . '</td>';
                    echo  '<td>' . $dong["address"] . '</td>';
                    echo  '<td>' . $dong["note"] . '</td>';
                    echo '<td><a href="delete.php?idship=' . $dong["id_shipping"] . '"><i class="fa-solid fa-trash"></i></a></td>';
                    echo '<td><a href="update.php?idship=' . $dong["id_shipping"] . '"><i class="fa-solid fa-pen-to-square"></i></a></td>';             
                    echo '</tr>';
                  }
                  ?>
